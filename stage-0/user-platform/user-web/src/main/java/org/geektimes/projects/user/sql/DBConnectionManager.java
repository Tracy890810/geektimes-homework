...
public class DBConnectionManager {
	...
	private static final CopyOnWriteArraySet<String> TABLES = new CopyOnWriteArraySet<String>();
	...
	public static void main(String[] args) throws Exception {
		...
		// Driver driver =
		// DriverManager.getDriver("jdbc:derby:/db/user-platform;create=true");
		// Connection connection =
		// driver.connect("jdbc:derby:/db/user-platform;create=true", new
		// Properties());
